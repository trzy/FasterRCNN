...
python -m pytorch.FasterRCNN --train --dataset-dir=VOCdevkit/VOC2007 --epochs=4 --learning-rate=1e-4 --load-from=fasterrcnn_pytorch_tmp.pth --save-best-to=fasterrcnn_pytorch.pth
