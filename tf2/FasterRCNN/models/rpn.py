#TODO: boxes and box regressions- >box_deltas? Same for detector.py
#
# FasterRCNN in PyTorch and TensorFlow 2 w/ Keras
# python/tf2/FasterRCNN/models/rpn.py
...
class RegionProposalNetwork(tf.keras.Model):
  ...
  def _extract_valid(self, anchor_map, anchor_valid_map, objectness_score_map, box_regression_map, allow_edge_proposals):
    ...
    if allow_edge_proposals:
      ...
      # intuitively, given that the FasterRCNN paper (Section 3.3) says that
